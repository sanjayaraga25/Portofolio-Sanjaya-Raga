...
@section('content')
    ...
    <div class="max-w-2xl glass rounded-2xl p-8">
        <h2 class="text-2xl font-display font-bold mb-6">Edit Experience</h2>
        ...
        <form method="POST" action="{{ route('admin.experiences.update', $experience) }}" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="description" required rows="4"
                    class="input-field resize-none @error('description') border-danger @enderror">{{ old('description', $experience->description) }}</textarea>
            ...
            <div class="grid grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="date" name="start_date" required value="{{ old('start_date', $experience->start_date->format('Y-m-d')) }}"
            ...
            <div class="flex gap-3 pt-6">
                <button type="submit" class="btn-primary magnetic-btn">Update Experience</button>

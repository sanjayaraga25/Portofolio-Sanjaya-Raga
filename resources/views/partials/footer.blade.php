    ...
    <div class="container-portfolio">
        <div class="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div class="flex gap-3">
                <a href="https://github.com/sanjayaraga25" target="_blank" rel="noopener" class="w-10 h-10 rounded-full flex items-center justify-center border border-white/10 text-secondary hover:text-primary hover:border-tertiary hover:bg-tertiary/10 hover:scale-110 transition-all">
                ...
                <a href="https://www.linkedin.com/in/sanjayaraga25" target="_blank" rel="noopener" class="w-10 h-10 rounded-full flex items-center justify-center border border-white/10 text-secondary hover:text-primary hover:border-tertiary hover:bg-tertiary/10 hover:scale-110 transition-all">

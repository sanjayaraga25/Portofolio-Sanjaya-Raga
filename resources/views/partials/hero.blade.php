    ...
    <div class="container-portfolio relative z-10 grid md:grid-cols-2 gap-12 items-center">
        <div class="space-y-6">
            ...
            <div class="flex flex-wrap gap-4 pt-4 reveal" style="transition-delay: 0.3s">
                ...
                <a href="{{ asset('assets/cv.pdf') }}" target="_blank" rel="noopener" class="btn-secondary magnetic-btn">
            ...
            <div class="flex gap-4 pt-4 reveal" style="transition-delay: 0.5s">
                <a href="https://github.com" target="_blank" rel="noopener" class="w-10 h-10 rounded-full flex items-center justify-center border border-white/10 text-secondary hover:text-primary hover:border-tertiary hover:bg-tertiary/10 transition-all hover:scale-110">
                ...
                <a href="https://linkedin.com" target="_blank" rel="noopener" class="w-10 h-10 rounded-full flex items-center justify-center border border-white/10 text-secondary hover:text-primary hover:border-tertiary hover:bg-tertiary/10 transition-all hover:scale-110">
